...
let bgVideoTemplate = '<video playsinline loop muted autoplay src="/builder/media/sample.webm" poster="/builder/media/sample.webp"><video>';
let bgImageTemplate = '<img src="/builder/media/4.jpg">';
