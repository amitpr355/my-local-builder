...
Vvveb.Undo = {
  ...
  */
  addMutation: function (mutation) {
    if (mutation && mutation.type === "childList" && !mutation.previousSibling) {
      const firstAdded = mutation.addedNodes && mutation.addedNodes[0];
      const firstRemoved = mutation.removedNodes && mutation.removedNodes[0];
      const firstNode = firstAdded || firstRemoved;
    ...
    */
    ...
    console.log("➕ Mutation added:", mutation, "UndoIndex:", this.undoIndex);
