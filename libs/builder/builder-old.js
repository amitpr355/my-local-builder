...
Vvveb.Builder = {
  ...
  _initHighlight: function () {
    ...
    let highlightMove = function (event) {
      const currentSection = event.target.closest("section") || hoveredSection || document.querySelector("iframe").contentDocument.querySelector("section");
...
`,
  ...
  init: function () {
    ...
    document.addEventListener("mousedown", (e) => {
      if (e.button === 0 && (
        e.target.classList.contains("padding-top-button") ||
  ...
  startDrag: function (e) {
    ...
    const onMouseMove = (moveEvent) => {
      ...
      const STEP = 8;        // Your increment (8px)
...
Vvveb.GlobalCustomVariable = {
  ...
  _syncGlobalFontHead(pair) {
    ...
    body.vvv-global-font-on,
    body.vvv-global-font-on p,
    body.vvv-global-font-on li,
    body.vvv-global-font-on a,
    body.vvv-global-font-on span,
    body.vvv-global-font-on button,
    body.vvv-global-font-on input,
    body.vvv-global-font-on textarea,
    body.vvv-global-font-on select {
      font-family: var(--vvv-font-b) !important;
    }

    body.vvv-global-font-on h1,
    body.vvv-global-font-on h2,
    body.vvv-global-font-on h3,
    body.vvv-global-font-on h4,
    body.vvv-global-font-on h5,
    body.vvv-global-font-on h6 {
...
Vvveb.IconSettings = {
  ...
  apply() {
        ...
        const undoOldHtml = undoTarget ? undoTarget.outerHTML : "";
    ...
    el.setAttribute(
        ...
        if (
            ...
            const undoNewHtml = undoTarget ? undoTarget.outerHTML : "";
