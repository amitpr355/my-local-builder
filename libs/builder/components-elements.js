...
// // Custom modification - comment out some elements - 27.7.25
...
Vvveb.Components.add("elements/gallery", {
    ...
    html: `
			<div class="gallery masonry has-shadow" data-component-gallery>
				<div class="item">
					<a>
						<img src="/builder/media/posts/1.jpg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="/builder/media/posts/2.jpg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="/builder/media/posts/3.jpg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="/builder/media/posts/4.jpg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="/builder/media/posts/5.jpg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="/builder/media/posts/6.jpg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="/builder/media/posts/7.jpg">
					</a>
				</div>
			</div>
			`,
		properties: [{
			...
			onChange: function(node) {
				 node.append(generateElements('<div class="item"><a><img src="/builder/media/posts/1.jpg"></a></div>')[0]);
    ...
    html: `<div class="flip-box enabled">
		  <div class="flip-box-inner">
			<div class="flip-box-front">
				  <div class="card">
				  <img src="/builder/media/posts/1.jpg" class="card-img-top" alt="Post">
				  <div class="card-body">
			...
			<div class="flip-box-back">
				<div class="d-flex align-items-center flex-column">
				  <div class="flex-shrink-0">
					<img src="/builder/media/posts/2.jpg" alt="Post">
				  </div>
...
Vvveb.Components.add("elements/carousel", {
    ...
    properties: [{
		...
		data: {
			...
			//"newElement": `<div class="swiper-slide"><img src="/builder/media/posts/1.jpg" class="img-fluid"><p>Slide 1</p></div>`
		},
        onChange: function(node, value, input, component, event) {
			let element = node;
			let dataset = {};
			...
			if (event.action) {
				if (event.action == "add") {
					...
					element.swiper.appendSlide(generateElements(`<div class="swiper-slide"><img src="/builder/media/posts/${random}.jpg" class="img-fluid"><p>Slide ${index}</p></div>`)[0]);
